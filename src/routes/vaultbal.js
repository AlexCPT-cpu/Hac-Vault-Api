...
async function vaultbal() {
  ...
  const firstArr = await firstContract.methods.balanceOf(vaultContract).call()
  const secondArr = await secondContract.methods.balanceOf(vaultContract).call()
  const thirdArr = await thirdContract.methods.balanceOf(vaultContract).call()
